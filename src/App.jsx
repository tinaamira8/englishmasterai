...
const LESSONS = [
  ...
  // A1 — new
  {
    id: 17, level: 'A1', title: 'العائلة والعلاقات',
    englishTitle: 'Family & Relationships',
    icon: '👨‍👩‍👧', duration: '١٠ دقائق',
    content: [
      { type: 'text', body: 'الحديث عن العائلة من أول ما تتعلمه في اللغة. تعلّم هذه الكلمات لتعريف نفسك وعائلتك.' },
      { type: 'phrase', items: [
        { en: 'Mother / Father', ar: 'أم / أب', note: 'الوالدان' },
        { en: 'Brother / Sister', ar: 'أخ / أخت', note: 'الإخوة' },
        { en: 'Husband / Wife', ar: 'زوج / زوجة', note: 'الزوجان' },
        { en: 'Son / Daughter', ar: 'ابن / ابنة', note: 'الأبناء' },
        { en: 'Grandfather / Grandmother', ar: 'جد / جدة', note: 'الأجداد' },
        { en: 'Uncle / Aunt', ar: 'عم / عمة أو خال / خالة', note: 'الأعمام والأخوال' },
        { en: 'Cousin', ar: 'ابن عم / ابن خال', note: 'أبناء العمومة' },
        { en: 'Friend / Best friend', ar: 'صديق / أعز صديق', note: 'الأصدقاء' },
      ]},
      { type: 'example', label: 'تعريف العائلة', body: '"This is my family. My father\'s name is Ahmed. My mother is a teacher. I have two brothers and one sister. My grandmother lives with us."' },
    ],
  },
  {
    id: 18, level: 'A1', title: 'الأيام والوقت',
    englishTitle: 'Days, Months & Time',
    icon: '📅', duration: '١٠ دقائق',
    content: [
      { type: 'text', body: 'معرفة الأيام والأشهر والوقت ضرورية في كل محادثة يومية.' },
      { type: 'phrase', items: [
        { en: 'Monday / Tuesday / Wednesday', ar: 'الاثنين / الثلاثاء / الأربعاء', note: 'أيام الأسبوع' },
        { en: 'Thursday / Friday / Saturday / Sunday', ar: 'الخميس / الجمعة / السبت / الأحد', note: 'بقية الأيام' },
        { en: 'January, February, March...', ar: 'يناير، فبراير، مارس...', note: 'أشهر السنة' },
        { en: 'What time is it?', ar: 'كم الساعة؟', note: 'السؤال عن الوقت' },
        { en: "It's half past three.", ar: 'الساعة الثالثة والنصف.', note: 'قراءة الوقت' },
        { en: 'In the morning / afternoon / evening', ar: 'في الصباح / بعد الظهر / المساء', note: 'أجزاء اليوم' },
        { en: 'Yesterday / Today / Tomorrow', ar: 'أمس / اليوم / غداً', note: 'الزمن' },
      ]},
      { type: 'example', label: 'تحديد موعد', body: '"Can we meet on Thursday at half past two in the afternoon?"\nهل يمكننا الاجتماع يوم الخميس في الساعة الثانية والنصف بعد الظهر؟' },
    ],
  },
  // A2 — new
  {
    id: 19, level: 'A2', title: 'الطقس والفصول',
    englishTitle: 'Weather & Seasons',
    icon: '🌤️', duration: '١٥ دقيقة',
    content: [
      { type: 'text', body: 'الحديث عن الطقس من أكثر المواضيع شيوعاً في المحادثات اليومية الإنجليزية.' },
      { type: 'phrase', items: [
        { en: "What's the weather like today?", ar: 'كيف الطقس اليوم؟', note: 'السؤال عن الطقس' },
        { en: "It's sunny / cloudy / rainy / windy.", ar: 'الجو مشمس / غائم / ممطر / عاصف.', note: 'وصف الطقس' },
        { en: "It's hot / cold / warm / freezing.", ar: 'الجو حار / بارد / دافئ / متجمد.', note: 'درجة الحرارة' },
        { en: 'Spring / Summer / Autumn / Winter', ar: 'الربيع / الصيف / الخريف / الشتاء', note: 'الفصول الأربعة' },
        { en: "I think it's going to rain.", ar: 'أعتقد أنه سيمطر.', note: 'توقع الطقس' },
        { en: "Don't forget your umbrella!", ar: 'لا تنسَ مظلتك!', note: 'نصيحة' },
      ]},
      { type: 'example', label: 'محادثة عن الطقس', body: 'A: What\'s the weather like in London?\nB: It\'s usually cloudy and rainy. In winter it\'s very cold.\nA: What about summer?\nB: Summer is warm and sometimes sunny — that\'s the best time to visit!' },
    ],
  },
  {
    id: 20, level: 'A2', title: 'الاتجاهات والأماكن',
    englishTitle: 'Directions & Places',
    icon: '🗺️', duration: '١٥ دقيقة',
    content: [
      { type: 'text', body: 'ستحتاج هذه العبارات عندما تطلب أو تعطي الاتجاهات في بلد يتحدث الإنجليزية.' },
      { type: 'phrase', items: [
        { en: 'Excuse me, where is the...?', ar: 'عفواً، أين يوجد...؟', note: 'طلب الاتجاه' },
        { en: 'Turn left / right', ar: 'اتجه يساراً / يميناً', note: 'الاتجاهات' },
        { en: 'Go straight ahead', ar: 'اذهب مباشرةً للأمام', note: 'الاستمرار' },
        { en: "It's next to / opposite / behind", ar: 'إنه بجانب / مقابل / خلف', note: 'المواضع' },
        { en: 'How far is it?', ar: 'كم تبعد المسافة؟', note: 'السؤال عن البعد' },
        { en: "It's about 10 minutes on foot.", ar: 'إنها قريبة، حوالي ١٠ دقائق سيراً.', note: 'الوقت المستغرق' },
        { en: 'Take the second street on the left.', ar: 'خذ الشارع الثاني على اليسار.', note: 'تعليمات دقيقة' },
      ]},
      { type: 'example', label: 'طلب الاتجاه', body: 'A: Excuse me, where is the nearest pharmacy?\nB: Go straight ahead, then turn left at the traffic lights. It\'s next to the supermarket.\nA: How far is it?\nB: About 5 minutes on foot.' },
    ],
  },
  // B1 — new
  {
    id: 21, level: 'B1', title: 'السفر والفندق',
    englishTitle: 'Travel & Hotel',
    icon: '✈️', duration: '٢٠ دقيقة',
    content: [
      { type: 'text', body: 'عند السفر إلى بلد ناطق بالإنجليزية ستحتاج هذه العبارات في المطار والفندق.' },
      { type: 'phrase', items: [
        { en: "I'd like to check in / check out.", ar: 'أريد تسجيل الدخول / المغادرة.', note: 'في الفندق' },
        { en: 'I have a reservation under the name...', ar: 'لدي حجز باسم...', note: 'عند الوصول' },
        { en: 'Is breakfast included?', ar: 'هل الفطور مشمول؟', note: 'سؤال مهم' },
        { en: "Could I have a wake-up call at 7?", ar: 'هل يمكنني طلب إيقاظ في الساعة ٧؟', note: 'خدمة الغرف' },
        { en: 'The air conditioning isn\'t working.', ar: 'التكييف لا يعمل.', note: 'إبلاغ عن مشكلة' },
        { en: 'Which gate is flight BA204?', ar: 'ما هو البوابة لرحلة BA204؟', note: 'في المطار' },
        { en: 'My luggage is missing.', ar: 'حقائبي مفقودة.', note: 'مشكلة شائعة' },
      ]},
      { type: 'example', label: 'في الفندق', body: 'Guest: I\'d like to check in. I have a reservation under Ahmed Al-Hassan.\nReceptionist: Welcome! Could I see your passport?\nGuest: Is breakfast included in the room?\nReceptionist: Yes, breakfast is served from 7 to 10 AM.' },
    ],
  },
  {
    id: 22, level: 'B1', title: 'الصحة واللياقة',
    englishTitle: 'Health & Fitness',
    icon: '💪', duration: '٢٠ دقيقة',
    content: [
      { type: 'text', body: 'مفردات الصحة واللياقة ضرورية للحياة اليومية وفي أوقات المرض.' },
      { type: 'phrase', items: [
        { en: 'I have a headache / stomachache / backache.', ar: 'عندي صداع / ألم في المعدة / ألم في الظهر.', note: 'وصف الألم' },
        { en: "I'm not feeling well.", ar: 'لا أشعر بتحسن.', note: 'الشعور بالمرض' },
        { en: 'I need to see a doctor.', ar: 'أحتاج إلى رؤية طبيب.', note: 'طلب المساعدة' },
        { en: 'I exercise three times a week.', ar: 'أمارس الرياضة ثلاث مرات في الأسبوع.', note: 'روتين اللياقة' },
        { en: 'I try to eat healthy food.', ar: 'أحاول تناول طعام صحي.', note: 'العادات الصحية' },
        { en: 'I need to lose / gain weight.', ar: 'أحتاج إلى إنقاص / زيادة وزني.', note: 'الوزن' },
        { en: 'I\'m allergic to penicillin.', ar: 'أنا حساس للبنسيلين.', note: 'الحساسية' },
      ]},
      { type: 'example', label: 'عند الطبيب', body: 'Doctor: What seems to be the problem?\nPatient: I\'ve had a headache for two days and I feel very tired.\nDoctor: Are you eating and sleeping well?\nPatient: Not really. I\'ve been working long hours.\nDoctor: I recommend rest and drinking more water.' },
    ],
  },
  {
    id: 23, level: 'B1', title: 'الوظائف والمهن',
    englishTitle: 'Jobs & Careers',
    icon: '💼', duration: '٢٠ دقيقة',
    content: [
      { type: 'text', body: 'تعلّم كيف تتحدث عن عملك ومهنتك بالإنجليزية — مهارة أساسية في بيئة العمل الدولية.' },
      { type: 'phrase', items: [
        { en: 'What do you do for a living?', ar: 'ماذا تعمل؟', note: 'السؤال عن المهنة' },
        { en: 'I work as an engineer / teacher / doctor.', ar: 'أعمل كمهندس / معلم / طبيب.', note: 'ذكر المهنة' },
        { en: 'I\'m self-employed / freelance.', ar: 'أعمل لحسابي الخاص / مستقلاً.', note: 'عمل حر' },
        { en: 'I\'m looking for a job.', ar: 'أبحث عن عمل.', note: 'البحث عن وظيفة' },
        { en: 'I have five years of experience in...', ar: 'لدي خمس سنوات خبرة في...', note: 'الخبرة' },
        { en: 'I\'d like to apply for this position.', ar: 'أود التقدم لهذا المنصب.', note: 'في المقابلة' },
        { en: 'What are the working hours?', ar: 'ما هي ساعات العمل؟', note: 'سؤال مهم' },
      ]},
      { type: 'example', label: 'مقابلة عمل', body: 'Interviewer: Tell me about yourself.\nCandidate: I\'m a software engineer with five years of experience. I\'ve worked mainly on mobile apps. I\'m looking for a new challenge in a growing company.\nInterviewer: Why do you want to leave your current job?\nCandidate: I want to grow and learn new skills.' },
    ],
  },
  // B2 — new
  {
    id: 24, level: 'B2', title: 'البيئة والطبيعة',
    englishTitle: 'Environment & Nature',
    icon: '🌍', duration: '٢٠ دقيقة',
    content: [
      { type: 'text', body: 'موضوع البيئة من أكثر المواضيع التي تُناقش في الإنجليزية اليوم — تعلّم المفردات الأساسية.' },
      { type: 'phrase', items: [
        { en: 'Climate change / Global warming', ar: 'تغير المناخ / الاحترار العالمي', note: 'قضية عالمية' },
        { en: 'Renewable energy', ar: 'الطاقة المتجددة', note: 'الطاقة النظيفة' },
        { en: 'Carbon footprint', ar: 'البصمة الكربونية', note: 'الأثر البيئي' },
        { en: 'Recycle / Reduce / Reuse', ar: 'إعادة التدوير / التقليل / إعادة الاستخدام', note: 'القاعدة الثلاثية' },
        { en: 'Deforestation / Pollution', ar: 'إزالة الغابات / التلوث', note: 'مشاكل بيئية' },
        { en: 'Sustainable development', ar: 'التنمية المستدامة', note: 'الحل طويل الأمد' },
        { en: 'Wildlife / Endangered species', ar: 'الحياة البرية / الأنواع المهددة بالانقراض', note: 'الحيوانات' },
      ]},
      { type: 'example', label: 'نقاش بيئي', body: '"We need to reduce our carbon footprint by switching to renewable energy. Deforestation and pollution are threatening wildlife around the world. Every individual can help by choosing to recycle and reduce waste."' },
    ],
  },
  {
    id: 25, level: 'B2', title: 'الإعلام والأخبار',
    englishTitle: 'Media & News',
    icon: '📰', duration: '٢٠ دقيقة',
    content: [
      { type: 'text', body: 'فهم وسائل الإعلام الإنجليزية يفتح لك عالماً من المعلومات. تعلّم مفردات الأخبار.' },
      { type: 'phrase', items: [
        { en: 'Breaking news', ar: 'أخبار عاجلة', note: 'أخبار فورية' },
        { en: 'Headline / Article / Editorial', ar: 'عنوان رئيسي / مقال / افتتاحية', note: 'أجزاء الصحيفة' },
        { en: 'According to reports...', ar: 'وفقاً للتقارير...', note: 'نقل الخبر' },
        { en: 'Fake news / Misinformation', ar: 'أخبار مزيفة / معلومات مضللة', note: 'مشكلة إعلامية' },
        { en: 'Social media / Influencer', ar: 'وسائل التواصل الاجتماعي / مؤثر', note: 'الإعلام الرقمي' },
        { en: 'The government announced that...', ar: 'أعلنت الحكومة أن...', note: 'أخبار رسمية' },
        { en: 'In my opinion / From my perspective', ar: 'في رأيي / من منظوري', note: 'إبداء الرأي' },
      ]},
      { type: 'example', label: 'قراءة الأخبار', body: '"According to recent reports, global temperatures have risen by 1.5 degrees. The government announced new policies to tackle climate change. In my opinion, we need stronger international cooperation to solve this problem."' },
    ],
  },
  {
    id: 26, level: 'B2', title: 'المشاعر والتعبير عنها',
    englishTitle: 'Emotions & Expressing Feelings',
    icon: '😊', duration: '٢٠ دقيقة',
    content: [
      { type: 'text', body: 'التعبير عن المشاعر بالإنجليزية يجعل تواصلك أكثر عمقاً وأصالة.' },
      { type: 'phrase', items: [
        { en: 'I feel overwhelmed / anxious / relieved.', ar: 'أشعر بالإرهاق / القلق / الارتياح.', note: 'مشاعر معقدة' },
        { en: 'I\'m thrilled / devastated / frustrated.', ar: 'أنا مبتهج / محطم / محبط.', note: 'مشاعر قوية' },
        { en: 'I can\'t help feeling...', ar: 'لا أستطيع إلا أن أشعر بـ...', note: 'مشاعر لا إرادية' },
        { en: 'I\'m proud of / disappointed in myself.', ar: 'أنا فخور بنفسي / خائب الأمل من نفسي.', note: 'تقييم الذات' },
        { en: 'That means a lot to me.', ar: 'هذا يعني لي الكثير.', note: 'التقدير' },
        { en: 'I\'m at a loss for words.', ar: 'لا أعرف ماذا أقول.', note: 'الدهشة' },
        { en: 'I need some time to think.', ar: 'أحتاج بعض الوقت للتفكير.', note: 'طلب مهلة' },
      ]},
      { type: 'example', label: 'تعبير عن المشاعر', body: '"I\'m thrilled that I passed the exam — I can\'t help feeling proud of myself. I was so anxious before the results, but now I\'m relieved. This means a lot to me after all the hard work."' },
    ],
  },
  // C1 — new
  {
    id: 27, level: 'C1', title: 'الإنجليزية الأكاديمية',
    englishTitle: 'Academic English',
    icon: '🎓', duration: '٢٥ دقيقة',
    content: [
      { type: 'text', body: 'الإنجليزية الأكاديمية لها أسلوب خاص. تعلّم هذه العبارات للكتابة البحثية والجامعية.' },
      { type: 'phrase', items: [
        { en: 'This paper aims to examine...', ar: 'تهدف هذه الورقة إلى دراسة...', note: 'بداية البحث' },
        { en: 'The evidence suggests that...', ar: 'تشير الأدلة إلى أن...', note: 'تقديم الحجة' },
        { en: 'In contrast to previous studies...', ar: 'على عكس الدراسات السابقة...', note: 'المقارنة' },
        { en: 'It can be concluded that...', ar: 'يمكن الاستنتاج أن...', note: 'الخاتمة' },
        { en: 'Furthermore / Moreover / Nevertheless', ar: 'علاوة على ذلك / مع ذلك', note: 'روابط أكاديمية' },
        { en: 'The findings indicate that...', ar: 'تشير النتائج إلى أن...', note: 'نتائج البحث' },
        { en: 'This is beyond the scope of this study.', ar: 'هذا خارج نطاق هذه الدراسة.', note: 'تحديد الحدود' },
      ]},
      { type: 'example', label: 'مقدمة بحث', body: '"This paper aims to examine the impact of social media on academic performance. The evidence suggests a negative correlation between excessive screen time and grades. Furthermore, previous studies indicate that students who limit social media use perform significantly better."' },
    ],
  },
  {
    id: 28, level: 'C1', title: 'التفاوض والإقناع',
    englishTitle: 'Negotiation & Persuasion',
    icon: '🤝', duration: '٢٥ دقيقة',
    content: [
      { type: 'text', body: 'مهارة التفاوض بالإنجليزية تفيدك في العمل والأعمال التجارية والحياة اليومية.' },
      { type: 'phrase', items: [
        { en: 'Could we find a middle ground?', ar: 'هل يمكننا إيجاد أرضية مشتركة؟', note: 'التوصل لحل' },
        { en: 'I understand your point, however...', ar: 'أفهم وجهة نظرك، غير أن...', note: 'الرد بأدب' },
        { en: 'What if we...?', ar: 'ماذا لو...؟', note: 'اقتراح بديل' },
        { en: 'I\'m afraid that\'s not acceptable.', ar: 'أخشى أن ذلك غير مقبول.', note: 'الرفض بأدب' },
        { en: 'That\'s a fair point.', ar: 'هذه نقطة وجيهة.', note: 'الاعتراف بالحجة' },
        { en: 'Let\'s agree to disagree.', ar: 'لنتفق على الاختلاف.', note: 'عند تعذر الاتفاق' },
        { en: 'I\'d like to propose a compromise.', ar: 'أود اقتراح تسوية.', note: 'تقديم حل وسط' },
      ]},
      { type: 'example', label: 'تفاوض تجاري', body: 'A: Our budget is $10,000. Can you work with that?\nB: I understand your budget constraints. However, for the full package, we need $13,000.\nA: What if we reduce the scope slightly?\nB: That\'s a fair point. Let me propose a compromise — $11,500 with a reduced timeline.' },
    ],
  },
  // C2 — new
  {
    id: 29, level: 'C2', title: 'النقاشات والحجج',
    englishTitle: 'Debates & Arguments',
    icon: '⚖️', duration: '٣٠ دقيقة',
    content: [
      { type: 'text', body: 'المستوى C2 يتطلب القدرة على الجدال والإقناع بأسلوب راقٍ ومنطقي.' },
      { type: 'phrase', items: [
        { en: 'I would argue that...', ar: 'أود أن أجادل بأن...', note: 'تقديم الحجة' },
        { en: 'The counterargument would be...', ar: 'الحجة المضادة ستكون...', note: 'الرأي الآخر' },
        { en: 'There is compelling evidence to suggest...', ar: 'هناك أدلة مقنعة تشير إلى...', note: 'تقديم دليل' },
        { en: 'One could make the case that...', ar: 'يمكن للمرء أن يثبت أن...', note: 'أسلوب أكاديمي' },
        { en: 'This raises the question of...', ar: 'هذا يطرح تساؤلاً حول...', note: 'طرح سؤال' },
        { en: 'To play devil\'s advocate...', ar: 'للعب دور المعارض...', note: 'اتخاذ موقف مخالف' },
        { en: 'The crux of the matter is...', ar: 'جوهر الأمر هو...', note: 'التركيز على النقطة الرئيسية' },
      ]},
      { type: 'example', label: 'نقاش أكاديمي', body: '"I would argue that social media has done more harm than good. There is compelling evidence to suggest rising rates of anxiety among young people. The counterargument would be that social media connects people globally — however, the crux of the matter is whether this connection is meaningful or superficial."' },
    ],
  },
  {
    id: 30, level: 'C2', title: 'الأدب والثقافة',
    englishTitle: 'Literature & Culture',
    icon: '📚', duration: '٣٠ دقيقة',
    content: [
      { type: 'text', body: 'إتقان الإشارات الأدبية والثقافية هو ما يميز المتحدث المحترف عن المجيد للغة.' },
      { type: 'phrase', items: [
        { en: 'This is a metaphor for...', ar: 'هذه استعارة عن...', note: 'تحليل أدبي' },
        { en: 'The theme of the novel revolves around...', ar: 'يتمحور موضوع الرواية حول...', note: 'تحليل النص' },
        { en: 'Culturally speaking...', ar: 'من الناحية الثقافية...', note: 'السياق الثقافي' },
        { en: 'This is a cultural reference to...', ar: 'هذه إشارة ثقافية إلى...', note: 'الإشارات الثقافية' },
        { en: 'Shakespeare coined the phrase...', ar: 'صاغ شكسبير عبارة...', note: 'أصل التعبير' },
        { en: 'Lost in translation', ar: 'ضاع في الترجمة', note: 'تعبير شهير' },
        { en: 'A work of art that transcends time', ar: 'عمل فني يتجاوز الزمن', note: 'وصف الأعمال الخالدة' },
      ]},
      { type: 'example', label: 'تحليل أدبي', body: '"In George Orwell\'s 1984, the concept of \'Big Brother\' is a metaphor for totalitarian surveillance. Culturally speaking, this phrase has transcended the novel and entered everyday language. When we say someone is \'watching you like Big Brother\', this is a cultural reference most English speakers immediately understand."' },
    ],
  },
  {
    id: 31, level: 'C2', title: 'الفكاهة والسخرية',
    englishTitle: 'Humor & Sarcasm',
    icon: '😄', duration: '٢٥ دقيقة',
    content: [
      { type: 'text', body: 'فهم الفكاهة الإنجليزية — خاصة السخرية البريطانية — من أصعب جوانب اللغة وأكثرها متعةً.' },
      { type: 'phrase', items: [
        { en: 'That\'s the understatement of the year.', ar: 'هذا أقل وصف ممكن!', note: 'تهوين ساخر' },
        { en: 'Oh, brilliant! (sarcastically)', ar: 'رائع جداً! (بسخرية)', note: 'سخرية بريطانية' },
        { en: 'I was being sarcastic.', ar: 'كنت أتحدث بسخرية.', note: 'توضيح' },
        { en: 'You can\'t be serious!', ar: 'لا يمكن أن تكون جاداً!', note: 'الدهشة' },
        { en: 'That\'s the story of my life.', ar: 'هذه قصة حياتي.', note: 'تعبير فكاهي' },
        { en: 'As if!', ar: 'كأن ذلك ممكن!', note: 'رفض بفكاهة' },
        { en: 'I\'m dead serious. / I\'m just kidding.', ar: 'أنا جاد تماماً. / كنت أمزح فقط.', note: 'التوضيح' },
      ]},
      { type: 'example', label: 'فكاهة بريطانية', body: 'A: It\'s only raining a little.\nB: A little? We\'re practically swimming! That\'s the understatement of the year.\nA: You can\'t be serious — it\'s just a drizzle.\nB: Oh, brilliant! A "drizzle" that\'s flooded my garden. That\'s the story of my life.' },
    ],
  },
  {
    id: 32, level: 'B1', title: 'التسوق الإلكتروني',
    englishTitle: 'Online Shopping',
    icon: '🛒', duration: '١٥ دقيقة',
    content: [
      { type: 'text', body: 'التسوق الإلكتروني أصبح جزءاً من حياتنا — تعلّم المصطلحات الإنجليزية الأساسية.' },
      { type: 'phrase', items: [
        { en: 'Add to cart / Proceed to checkout', ar: 'أضف إلى السلة / تابع للدفع', note: 'خطوات الشراء' },
        { en: 'This item is out of stock.', ar: 'هذا المنتج نفد من المخزون.', note: 'غير متوفر' },
        { en: 'Free shipping / Express delivery', ar: 'شحن مجاني / توصيل سريع', note: 'خيارات الشحن' },
        { en: 'I\'d like to return this item.', ar: 'أريد إرجاع هذا المنتج.', note: 'سياسة الإرجاع' },
        { en: 'The discount code is...', ar: 'رمز الخصم هو...', note: 'الخصومات' },
        { en: 'Customer reviews / Rating', ar: 'تقييمات العملاء / التقييم', note: 'قبل الشراء' },
        { en: 'My order hasn\'t arrived yet.', ar: 'طلبي لم يصل بعد.', note: 'تتبع الطلب' },
      ]},
      { type: 'example', label: 'خدمة العملاء', body: 'Customer: Hi, my order hasn\'t arrived yet. I placed it 10 days ago.\nAgent: I apologize for the delay. Could you share your order number?\nCustomer: It\'s #45321.\nAgent: I can see it\'s been dispatched. It should arrive within 2 business days. We\'ll offer you a discount code for the inconvenience.' },
    ],
  },
]
